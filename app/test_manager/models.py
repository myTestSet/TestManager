...
class Project(BaseTimeModelMixin):
    '''
    项目
    '''
...
class Suite(BaseTimeModelMixin):
    '''
    测试用例集
    集合相关 所有的 testcase，
    主要用来存储全局配置
    ...
    # 公共参数，常用参数为基础 url，
    request = models.TextField(max_length=1024, blank=True, null=True)
